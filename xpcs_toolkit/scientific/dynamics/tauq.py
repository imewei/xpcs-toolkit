"""
Tau-q dynamics visualization for XPCS relaxation time analysis.
...
def plot(xf_list, hdl, q_range, offset, plot_type=3):
    """
    Plot tau-q relationship for XPCS dynamics analysis.
...
def plot_pre(xf_list, hdl):
    """
    Create preliminary fitting parameter plots for XPCS dynamics analysis.
