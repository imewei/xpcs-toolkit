...
from xpcs_toolkit.fileIO import hdf_reader, qmap_utils, ftype_utils
    ...
    def test_put_function_mode_validation(self):
        ...
        try:
            ...
            with pytest.raises(ValueError, match="Unsupported mode"):
                hdf_reader.put(tmp_path, test_data, file_type="nexus", mode="invalid_mode")
    ...
    def test_cache_key_generation(self):
        ...
        try:
            ...
            with h5py.File(tmp_path, 'w') as f:
                ...
                qmap_group = xpcs_group.create_group('qmap')
            ...
            with patch.object(qmap_utils, 'key_map', {'nexus': {
                'bcx': 'bcx',
                'bcy': 'bcy', 
                'X_energy': 'X_energy',
        ...
        try:
            ...
            with h5py.File(nexus_path, 'r') as f:
                ...
                if stored_array.ndim > test_data['integration_test'].ndim:
                    stored_array = stored_array.squeeze()
                np.testing.assert_array_equal(stored_array, test_data['integration_test'])
