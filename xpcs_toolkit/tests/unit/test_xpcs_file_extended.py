...
class TestXpcsDataFileDataAccess:
    ...
    def setup_method(self):
        ...
        with h5py.File(self.temp_file.name, 'w') as f:
            ...
            f.create_dataset('exchange/g2', data=g2)  # This helps analysis type detection
    ...
    def test_get_g2_data_basic(self):
        ...
        with patch.object(xf, 'get_g2_data') as mock_method:
            ...
            mock_method.return_value = (mock_q, mock_tau, mock_g2, mock_g2_err, mock_labels)
...
class TestXpcsDataFileCorrelationAnalysis:
    ...
    @pytest.mark.skip(reason="fit_g2_function method not implemented in current XpcsDataFile")
    def test_fit_g2_function_basic(self):
        ...
        with patch.object(xf, 'fit_g2_function') as mock_fit:
            ...
            mock_results = {
                'fit_val': np.array([[0.5, 0.01, 1.0, 1.0]]),  # [beta, tau, baseline, amplitude]
                ...
                'fit_flag': [True, True, False, False]  # Fit beta and tau, fix baseline and amplitude
            }
    ...
    def test_fit_g2_function_different_models(self):
        ...
        for model in models:
            with patch.object(xf, 'fit_g2_function') as mock_fit:
                mock_results = {'fit_val': np.array([[0.5, 0.01]]), 'fit_line': [{'success': True}]}
                mock_fit.return_value = mock_results
...
class TestXpcsDataFileStringRepresentation:
    ...
    def test_string_representation(self):
        ...
        with patch.object(type(xf), 'label', new_callable=lambda: property(lambda self: 'test_file')):
            str_repr = str(xf)
