...
class TestFileLocatorBackwardCompatibility:
    ...
    def test_api_compatibility(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            data_methods = [
                attr for attr in dir(data_locator) if not attr.startswith("_")
            ]
            file_methods = [
                attr for attr in dir(file_locator) if not attr.startswith("_")
            ]
...
class TestDataFileLocatorCaching:
    ...
    def test_cache_initialization(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            any(hasattr(locator, attr) for attr in cache_attrs)
