...
def test_module_imports_new_name():
    ...
    from xpcs_toolkit.mpl_compat import DataTreeWidget, PlotWidget
...
def test_parameter_name_backward_compatibility():
    ...
    from xpcs_toolkit.fileIO.hdf_reader import get_abs_cs_scale
...
def test_mpl_compat_functionality():
    ...
    from xpcs_toolkit.mpl_compat import DataTreeWidget, MockSignal, PlotWidget
